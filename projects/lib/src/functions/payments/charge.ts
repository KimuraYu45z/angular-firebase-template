...
import { IPayment } from "../../lib/core/types/i-payment";
import { path } from './path';

export function chargeFactory<
  Payment extends IPayment<admin.firestore.Timestamp>
>(paymentFactory: (iPayment: IPayment<admin.firestore.Timestamp>) => Payment) {
  return functions.https.onRequest(async (req, res) => {
    try {
      ...
      const iPayment: IPayment<admin.firestore.Timestamp> = {
